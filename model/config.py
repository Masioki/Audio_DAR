from model.layers.prosody_encoder import ProsodyEncoder
...
BACKBONES = {
    ...
    "prosody-encoder384": (384, lambda **kwargs: ProsodyEncoder(out_size=384, **kwargs)),
    "prosody-encoder192": (192, lambda **kwargs: ProsodyEncoder(out_size=192, **kwargs)),
}
